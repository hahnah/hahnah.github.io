...
- 対雨パ2: ドラパルト+キュウコン+メガバンギラス
  - 相手がペリッパー+メガグソクムシャ+ブリジュラスの場合は、メガグソクムシャを倒せるように炎技持ち3匹で挑みます。メガグソクムシャ入り雨パは、グソクムシャを死に出し、もしくは初手出ししてくることが確定的なので、前述の雨パ1と同じ対応で良いです。もし初手メガグソクムシャを出されたら、賭けになりますがこちらの初手ドラパルとのだいもんじで倒す試みをします。もし相手にA特化ふいうちがあれば87.5%で負けますが、これが最善策です。ただし、上手い相手だと1ターン目は炎技を警戒してメガシンカしてこないことがあります。その場合は2ターンめも続けてだいもんじをするのが最適解です。2ターン目に相手がメガシンカしてこなければ特性ききかいひ発動ラインまでダメージを確定で与えられ、メガシンカしてくるようなら確定で倒せます。
- 対雪パ: キュウコン
