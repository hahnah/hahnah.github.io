...
- 役割対象:
  ...
  - ブリジュラス: 初手に出てきやすい相手です。ひでり+かえんほうしゃで確定1発ですが、相手は特性がんじょうなので実質確定2発です。相手のC特化りゅうせいぐんは確定2発なので対面で勝てます。
...
- 技と採用意図:
  ...
  - ステルスロック: 2匹で受けループが成立する場合(典型的にはドヒドイデ+エアームド)に使います。ループ合戦になると引き分けになりがちなのですが、ステルスロックを撒いておくと勝ちに出来ることがあるので採用しています。他の技候補として、じわれやラスターカノンも試したのですが、これといって役割対象もなく勝ちに繋がったことがありませんでした。多くの試合を経て集計した限り、ステルスロックの採用により勝率が5%程度上昇するはずです。
- 役割対象:
...
- 技と採用意図:
  ...
  - だいもんじ: メガメタグロスをはじめとする鋼ポケモンを暑く対策するために採用しました。キュウコンと組み合わせて、にほんばれ下だいもんじでメガメタグロスを倒します。
...
- ソウブレイズ: 相手がきあいのたすきを持っていることが多く、対面で確実に勝てるポケモンがこちらにいないため、2匹がかりで倒すことになり不利を強いられます。
- メガマフォクシー: メガバクーダとドラパルトが勝てるのですが、相手がメガマフォクシー+アシレーヌの選出をしている場合に不利なサイクル戦になります。もしかしたらドラパルトの10まんボルトを、かみなりに変えた方が勝率が上がるかも知れません。
- メガピクシー: キュウコンがなんとかしてくれます。他の方法では止められません。
- ギルガルド: ドヒドイデのどくどくが無効かつエアームドのボディプレスが無効なので、受けループの要であるのこの2匹では成す術がないです。選出をしっかり練らないと不利な戦いになります。
...
- 受けループ枠の3匹で苦手だと感じるのは、メガマフォクシー、メガメタグロス、メガゲンガー、メガリザードンX、ギルガルド、エンニュート、コノヨザル、あたりです。これらにはアタッカー枠の3匹がうまく対処してくれます。
